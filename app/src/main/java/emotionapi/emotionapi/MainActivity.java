...
public class MainActivity extends AppCompatActivity {
    ...
    public void getEmotion(View view) {
        ...
        if(!emotion.equals(""))
        {
            EmotionChanger emotionChanger = new EmotionChanger();
            emotionChanger.execute();
            if (displayEmotion.equals("200"))
            {
                final AlertDialog alertDialog = new AlertDialog.Builder(getApplicationContext()).create();
                alertDialog.setMessage("Now within the next 30 seconds take the selfie with the emotional player!");
                alertDialog.setTitle("e.motion Success");
    ...
    private class GetEmotionCall extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog.setMessage("Getting emotion....");
            progressDialog.setTitle("e.motion");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                resultText.setText("No emotion detected. Try again later"+ e.getMessage());
                progressDialog.dismiss();
            }
        }
    }

    // asynchronous class which makes the api call for setting emotion to player in the background
    private class EmotionChanger extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                URIBuilder builder = new URIBuilder("https://fcbemotion.azurewebsites.net/api/Emotion/" + emotion);
                ...
                //postParameters.add(new  BasicNameValuePair("emotion", emotion));
